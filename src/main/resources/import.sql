...
INSERT INTO uispecs(uispec_id, label, attribure, formtype_id, detail, pageimage_id, event) VALUES (2, 'นามสกุล', 'lastName',  2, 'Maxlength: 20, ใช้ตัวอักษร', 1, 'None');
INSERT INTO uispecs(uispec_id, label, attribure, formtype_id, detail, pageimage_id, event) VALUES (3, 'อีเมล', 'email',  2, 'Maxlength: 20', 1, 'None');
...
INSERT INTO uispecs(uispec_id, label, attribure, formtype_id, detail, pageimage_id, event) VALUES (24, 'ปุ่มยกเลิก', 'cancelBtn',  6, 'Default', 3, 'เมือกดปุ่ม 1. ถ้า regisId มีค่า ทําการ clear หน้าจอ และทําการค้นหาข้อมูลเป็นค่าเริ่มต้นสําหรับแก้ไขข้อมูล2. ถ้า regisId ไม่มีค่า ทําการ clear หน้าจอเป็นค่าเริ่มต้นสําหรับเพิ่มข้อมูล');
